...
?>
		...
		printf( esc_html__( 'Copyright &copy; %1$s %2$s , All Right Reserved. %3$s Thema desenvolvido por %4$s',
		 'shopstore' ), esc_attr( date( 'Y' ) ), esc_html( get_bloginfo( 'name' ) ),
		  '<br/>', '<a href="'.esc_attr( 'https://hu3.info' ).'" target="_blank" rel="nofollow">'.esc_html_x( ' HU3 Informática', 'credit to cms', 'shopstore' ).'</a>' );
