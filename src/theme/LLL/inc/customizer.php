...
/**
 * LLL Theme Customizer
 *
 * @package LLL
 */

 function lll_customizer( $wp_customize ){
	...
	$wp_customize->add_setting(
		'set_deal_show', array(
			'type'					=> 'theme_mod',
			'default'				=> '',
			'sanitize_callback'		=> 'lll_sanitize_checkbox'
		)
	);
...
add_action( 'customize_register', 'lll_customizer' );

function lll_sanitize_checkbox( $checked ){
