					...
					<div class="flexslider">
					  <ul class="slides">
						...
						if($slider_loop->have_posts()):
					  	...
					  	?>
					    <li>
					      	<?php the_post_thumbnail( 'size-slider', array('class' =>'img-fluid') );?>
							<div class="container slider-box">
								...
								<div class="slider-description">
									...
									<a class="btn btn-primary link" role="button" href="<?php echo $slider_button_url[$j] ?>" class="link"><?php echo $slider_button_text[$j] ?></a>
								</div>
							</div>
						</li>
